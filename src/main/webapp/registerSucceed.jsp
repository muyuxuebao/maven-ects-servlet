...
<div id="wrap">
       ...
       <div class="center_content">
          ...
          <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>注册成功</div>
        
        	<div class="feat_prod_box_details">
            
           
            <table width="100%" align="center" >
            <tr><td colspan="3" align="center">欢迎进入落墨书城</td><td></td></tr>
            	<tr>
                	
                    <td align="left"> <a href="#" class="checkout">${sessionScope.user.name }</a></td>
                    <td align="center"><a href="category.jsp" class="continue"> 继续购物</a></td>
                    <td align="right"> <a href="order.jsp" class="checkout"> 结账</a></td>
              </tr>
             </table>
