...
<div id="wrap">
     ...
     <div class="center_content">
       	<div class="left_content">
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>新用户注册</div>
        
        	<div class="feat_prod_box_details">
            <p class="details">
             只有正式注册的用户，才可以进行交易活动。注册快捷、简单
            </p>
            
              	<div class="contact_form">
                <div class="form_subtitle">创建新帐户</div>
                 <form name="register" action="${pageContext.request.contextPath}/SaveUserServlet" method="post"et">          
                    <div class="form_row">
                    <strong>姓名:</strong>
                    ...
                    <div class="form_row">
                        ...
                        我同意 <a href="#">BookStor的条款 &amp; 规定</a>                        </div>
                    </div> 
