...
<div id="wrap">
      ...
      <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>特刊</div>
        	...
        	<div class="feat_prod_box">
                ...
                <div class="prod_det_box">
                    ...
                    <p class="details">书的内容好比房屋的组成元素，计算机元素分为文字、表格、图、范例。</p>
        	...
        	<div class="feat_prod_box">
                ...
                <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                    ...
                    <p class="details">aryCornell是康涅狄格大学的教授，也是广大开发人员喜爱的技术作家，许多著作都广受好评。</p>
                    <a href="details.jsp" class="more">- 更多细节-</a>
                    <div class="clear"></div>
                    </div>
        	...
        	<div class="feat_prod_box">
                ...
                <div class="prod_det_box">
                    ...
                    <div class="box_center">
                    <div class="prod_title">Product name</div>
                    <p class="details">本书适合于Java程序员、架构设计师及设计模式爱好者，是一本实用的设计原则和设计模式的自学教材和使用手册。</p>
                    <a href="details.jsp" class="more">- 更多细节 -</a>
                    <div class="clear"></div>
                    </div>
        	...
        	<div class="feat_prod_box">
                ...
                <span class="special_icon"><img src="images/special_icon.gif" alt="" title="" /></span>
                    ...
                    <div class="box_center">
                    <div class="prod_title">Product name</div>
                    <p class="details">本书由互联网上影响广泛的开放文档OpenDoc系列自由文献首份文档"Hibernate开发指南"发展而来。</p>
                    <a href="details.jsp" class="more">- 更多细节 -</a>
                    <div class="clear"></div>
                    </div>
